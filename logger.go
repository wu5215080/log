...
func (l *Logger) Trace(v ...interface{}) {
	l.Output(3, LevelTrace, fmt.Sprint(v...))
}
...
func (l *Logger) Warn(v ...interface{}) {
	l.Output(3, LevelWarn, fmt.Sprint(v...))
}
...
func (l *Logger) Fatal(v ...interface{}) {
	l.Output(3, LevelFatal, fmt.Sprint(v...))
}

//log with Trace level
func (l *Logger) Tracef(format string, v ...interface{}) {
	l.Output(3, LevelTrace, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Warnf(format string, v ...interface{}) {
	l.Output(3, LevelWarn, fmt.Sprintf(format, v...))
}
...
func (l *Logger) Fatalf(format string, v ...interface{}) {
	l.Output(3, LevelFatal, fmt.Sprintf(format, v...))
}
